...
**Stand:** 2026-06-10  
**Status:** fuehrend fuer manuelle Paddle-Maintenance (Diagnose, seltene Mutationen). Phase-7-Review-Artefakt; nach Freigabe in die Originaldatei ueberfuehrt oder direkt fuehrend gemacht.  
...
**Ersetzt nach Freigabe:** [`Paddle_API_Commands & Scripts.md`](./Paddle_API_Commands%20%26%20Scripts.md).
...
| Backend-API-Wrapper erklaeren | `Konzept Paddle-Integration und App-Architektur_updated.md` |
