...
**Vorgaenger:** Frueherer Konzeptstand (vor Astro-Konsolidierung, rund 870 Zeilen Hero-Varianten, FAQ und Trust-Wording) wurde am 2026-06-10 in diese Datei konsolidiert; Volltext in der Git-Historie.
...
Diese Tabelle ist die Marketing-Wording-Sicht auf die Pricing-Tiers. Die produktstrategische Sicht steht in [`Freemium-Modell.md`](./Freemium-Modell.md) §1.
...
- [`Konzept Paddle-Integration und App-Architektur.md`](./Konzept%20Paddle-Integration%20und%20App-Architektur.md) - Billing-, Entitlement- und Checkout-Architektur.
- [`Referenznetzwerk-Tests.md`](./Referenznetzwerk-Tests.md) - Absicherung von Netzwerk-/Planlogik.
