...
**Stand:** 2026-06-10  
**Status:** Konzept-Master / nicht implementiert.  
...
**Vorgaenger:** v3-Konsolidierungsstand 2026-05-26 wurde am 2026-06-10 in diese Datei konsolidiert; Volltext-Detailspezifikation in der Git-Historie.
**Vollstaendige Konzept-Detailspezifikation:** [`_offene Tasks und offene Ideen.md`](./_offene%20Tasks%20und%20offene%20Ideen.md) §3 — dort sind alle Master-Entscheidungen, Schwachstellen-Tabelle, Versionshistorie, Zielbild-Diagramm und Datenmodell konsolidiert. Bei produktiver Umsetzung ist §3 die fuehrende Quelle.
...
- [`Freemium-Modell.md`](./Freemium-Modell.md) - aktuelles Auth-/Entitlement-Modell und bekannte Trial-/Free-Abweichungen.
- [`Konzept Paddle-Integration und App-Architektur.md`](./Konzept%20Paddle-Integration%20und%20App-Architektur.md) - Checkout-/Account-Kontext, an dem Sponsor-Conversion spaeter andockt.
