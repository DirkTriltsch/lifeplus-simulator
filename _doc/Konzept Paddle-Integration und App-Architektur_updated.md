...
**Stand:** 2026-06-10  
**Status:** fuehrend (Architektur-Master fuer Auth, Billing, Webhook, Entitlements). Diese `_updated.md`-Datei ist ein Phase-7-Review-Artefakt und ersetzt die alte Konzeptdatei fachlich; nach formaler Freigabe wandert sie in die Originaldatei oder wird zur fuehrenden Datei erklaert.  
...
**Ersetzt nach Freigabe:** [`Konzept Paddle-Integration und App-Architektur.md`](./Konzept%20Paddle-Integration%20und%20App-Architektur.md).
