...
import { getActiveDevices, grantProEntitlementIfMissing, upsertUserByEmail } from '../../_lib/db';
...
export const onRequest: PagesFunction<Env> = async ({ request, env }) => {
  ...
  await grantProEntitlementIfMissing(env, user.id, env.BRAND_ID, nowMs(), randomId);
