...
-- Aufruf:
--   npx wrangler d1 execute lifeflow360-prod --remote --file scripts/sql/delete-user.sql
--   npx wrangler d1 execute lifeflow360-prod --local  --file scripts/sql/delete-user.sql
--
