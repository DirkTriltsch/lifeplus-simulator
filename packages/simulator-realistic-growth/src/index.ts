...
import { dirichletWeights } from './strategies/dirichlet';
import { computeMomentumWeights } from './strategies/momentum';
import { createRng } from './rng';

export * from './contracts';
export { dirichletWeights } from './strategies/dirichlet';
export { computeMomentumWeights } from './strategies/momentum';
